# %%
"""
1. Disaggregate OD matrix from multi-admin-layers to output areas
2. Predict OD matrix from 2011 to 2021
p.s. OD matrix: UK, 2011, Number of passengers taking cars
"""
...
# %%
od11_gb = pd.read_csv(
    os.path.join(base_path, "od_gb_2011_adminLevel.csv")
...
# Scottish population 11 at LSOA and OA levels
...
# %%
# from Scotland to ENW (oa-msoa) -> disaggregation
...
# %%
# (to estimate) msoa11_oa21_ratio21
...
# %%
# Trip disaggregation
# oa21 = max(msoa11_oa21_pop21[msoa11], key=msoa11_oa21_pop21[msoa11].get)
